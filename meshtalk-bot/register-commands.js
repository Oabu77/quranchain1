...
const commands = [
  new SlashCommandBuilder().setName("talk-status").setDescription("MeshTalk system status — all communication services"),
  new SlashCommandBuilder().setName("talk-services").setDescription("Communication services — messaging, voice, video, files"),
  new SlashCommandBuilder().setName("talk-encryption").setDescription("Encryption & zero-knowledge privacy details"),
  new SlashCommandBuilder().setName("talk-platforms").setDescription("Available platforms — web, desktop, iOS, Android, CLI"),
  new SlashCommandBuilder().setName("talk-federation").setDescription("Cross-mesh federation & bridging"),
  new SlashCommandBuilder().setName("talk-mesh").setDescription("Underlying FungiMesh network info"),
  new SlashCommandBuilder().setName("talk-api").setDescription("Developer API reference & WebSocket endpoints"),
  new SlashCommandBuilder().setName("talk-help").setDescription("MeshTalk bot commands"),
...
(async () => {
  console.log(`Registering ${commands.length} MeshTalk commands...`);
  if (GUILD_ID) {
