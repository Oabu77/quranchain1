// DarEnergy — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarEnergy", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarEnergy | Clean Energy & Sustainability | DarCloud Empire</title>
<meta name="description" content="Islamic-aligned clean energy solutions. Solar, wind, and sustainable infrastructure with Shariah-compliant financing.">
<style>
...
<section class="hero">
  <p style="color:#eab308;font-weight:600;margin-bottom:.5rem">Clean Energy & Sustainability</p>
  <h1><span>DarEnergy</span></h1>
  <p>Islamic-aligned clean energy solutions. Solar, wind, and sustainable infrastructure with Shariah-compliant financing.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">100%</div><div class="label">Renewable</div></div><div class="stat"><div class="val">0</div><div class="label">Carbon</div></div><div class="stat"><div class="val">Sukuk</div><div class="label">Financing</div></div><div class="stat"><div class="val">Global</div><div class="label">Operations</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\u2600\uFE0F</div><h3>Solar Projects</h3><p>Mosque and community solar installations with Sukuk-based financing</p></div><div class="card"><div class="icon">\uD83D\uDCA8</div><h3>Wind Energy</h3><p>Distributed wind energy generation integrated with FungiMesh monitoring</p></div><div class="card"><div class="icon">\uD83D\uDD0B</div><h3>Energy Storage</h3><p>Community battery storage and microgrid solutions for energy independence</p></div><div class="card"><div class="icon">\uD83D\uDCB0</div><h3>Green Sukuk</h3><p>Shariah-compliant green bonds for sustainable energy project financing</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>Smart Grid</h3><p>AI-optimized energy distribution through mesh-connected smart grid</p></div><div class="card"><div class="icon">\uD83C\uDF31</div><h3>Carbon Credits</h3><p>Blockchain-verified carbon offset credits and sustainability certificates</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Monitor</h3><div class="amount">Free</div><ul><li>Energy tracking</li><li>Carbon calculator</li><li>Community stats</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Producer</h3><div class="amount">$99<span>/mo</span></div><ul><li>Solar dashboard</li><li>Grid management</li><li>Energy trading</li><li>Credits</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Developer</h3><div class="amount">$999<span>/mo</span></div><ul><li>Project financing</li><li>Sukuk issuance</li><li>Full analytics</li><li>API</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
