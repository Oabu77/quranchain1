// DarHR — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarHR", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarHR | Islamic Human Resources & Workforce | DarCloud Empire</title>
<meta name="description" content="Shariah-compliant HR management. Halal payroll, Islamic benefits, and workforce solutions for Muslim organizations.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F R</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#ec4899;font-weight:600;margin-bottom:.5rem">Islamic Human Resources & Workforce</p>
  <h1><span>DarHR</span></h1>
  <p>Shariah-compliant HR management. Halal payroll, Islamic benefits, and workforce solutions for Muslim organizations.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">0%</div><div class="label">Riba Payroll</div></div><div class="stat"><div class="val">AI</div><div class="label">Recruiting</div></div><div class="stat"><div class="val">100%</div><div class="label">Compliant</div></div><div class="stat"><div class="val">Global</div><div class="label">Workforce</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDCBC</div><h3>Halal Payroll</h3><p>Zero-riba payroll processing with Zakat auto-calculation and DarPay integration</p></div><div class="card"><div class="icon">\uD83D\uDD0D</div><h3>AI Recruiting</h3><p>AI-powered talent matching with Islamic values alignment screening</p></div><div class="card"><div class="icon">\uD83D\uDDD3\uFE0F</div><h3>Prayer Scheduling</h3><p>Automatic prayer break scheduling and Jummah accommodation</p></div><div class="card"><div class="icon">\uD83C\uDFC6</div><h3>Islamic Benefits</h3><p>Takaful insurance, Hajj savings plans, and Islamic retirement programs</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>Performance</h3><p>Islamic values-based performance reviews with 360-degree feedback</p></div><div class="card"><div class="icon">\uD83C\uDF93</div><h3>Training</h3><p>DarEdu-integrated professional development and Islamic leadership programs</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Startup</h3><div class="amount">$29<span>/mo</span></div><ul><li>Up to 10 employees</li><li>Basic payroll</li><li>Prayer scheduling</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Business</h3><div class="amount">$99<span>/mo</span></div><ul><li>Up to 100 employees</li><li>Full HR suite</li><li>AI recruiting</li><li>Benefits</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$499<span>/mo</span></div><ul><li>Unlimited</li><li>Dedicated support</li><li>Custom workflows</li><li>API</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
