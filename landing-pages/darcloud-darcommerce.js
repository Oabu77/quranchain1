// DarCommerce — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarCommerce", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarCommerce | Halal E-Commerce Platform | DarCloud Empire</title>
<meta name="description" content="End-to-end halal e-commerce infrastructure. From storefront to fulfillment, every transaction is Shariah-compliant.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F e</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#f97316;font-weight:600;margin-bottom:.5rem">Halal E-Commerce Platform</p>
  <h1><span>DarCommerce</span></h1>
  <p>End-to-end halal e-commerce infrastructure. From storefront to fulfillment, every transaction is Shariah-compliant.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">$2.7T</div><div class="label">Halal Market</div></div><div class="stat"><div class="val">0%</div><div class="label">Riba</div></div><div class="stat"><div class="val">100%</div><div class="label">Halal Certified</div></div><div class="stat"><div class="val">24/7</div><div class="label">Operations</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDED2</div><h3>Halal Storefront</h3><p>Launch your halal-certified online store in minutes with pre-built templates</p></div><div class="card"><div class="icon">\uD83D\uDCE6</div><h3>Logistics</h3><p>Integrated halal supply chain with cold-chain for food and pharmaceutical products</p></div><div class="card"><div class="icon">\uD83D\uDCB0</div><h3>DarPay Checkout</h3><p>Seamless checkout with DarPay — zero-riba, multi-currency, instant settlement</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>Analytics</h3><p>Real-time sales analytics, inventory management, and demand forecasting</p></div><div class="card"><div class="icon">\u2705</div><h3>Certification</h3><p>Built-in halal certification tracking and compliance documentation</p></div><div class="card"><div class="icon">\uD83C\uDF0D</div><h3>Global Reach</h3><p>Ship worldwide with integrated customs, duties, and halal compliance documentation</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Starter</h3><div class="amount">$19<span>/mo</span></div><ul><li>100 products</li><li>Basic storefront</li><li>DarPay checkout</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Growth</h3><div class="amount">$79<span>/mo</span></div><ul><li>Unlimited products</li><li>Custom domain</li><li>Analytics</li><li>API access</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$399<span>/mo</span></div><ul><li>Multi-store</li><li>ERP integration</li><li>Dedicated support</li><li>Custom dev</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
