// DarTrade — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarTrade", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarTrade | Islamic Trade & Import-Export Platform | DarCloud Empire</title>
<meta name="description" content="Shariah-compliant international trade finance, letter of credit, and cross-border commerce infrastructure.">
<style>
...
<section class="hero">
  <p style="color:#0ea5e9;font-weight:600;margin-bottom:.5rem">Islamic Trade & Import-Export Platform</p>
  <h1><span>DarTrade</span></h1>
  <p>Shariah-compliant international trade finance, letter of credit, and cross-border commerce infrastructure.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">190+</div><div class="label">Countries</div></div><div class="stat"><div class="val">Murabaha</div><div class="label">Trade Finance</div></div><div class="stat"><div class="val">$0</div><div class="label">Interest</div></div><div class="stat"><div class="val">Blockchain</div><div class="label">Verified</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDEA2</div><h3>Trade Finance</h3><p>Murabaha and Musharakah-based trade financing with transparent cost-plus pricing</p></div><div class="card"><div class="icon">\uD83D\uDCDC</div><h3>Letter of Credit</h3><p>Islamic LC issuance and management across 190+ countries</p></div><div class="card"><div class="icon">\uD83D\uDCE6</div><h3>Supply Chain</h3><p>End-to-end supply chain tracking with blockchain verification</p></div><div class="card"><div class="icon">\uD83D\uDCB1</div><h3>FX Services</h3><p>Competitive forex rates with Shariah-compliant hedging instruments</p></div><div class="card"><div class="icon">\uD83D\uDCC4</div><h3>Documentation</h3><p>Automated trade documentation, customs declarations, and compliance filings</p></div><div class="card"><div class="icon">\uD83E\uDD1D</div><h3>B2B Matching</h3><p>AI-powered buyer-seller matching for halal products and commodities</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Trader</h3><div class="amount">$49<span>/mo</span></div><ul><li>10 transactions/mo</li><li>Basic LC</li><li>Trade docs</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Business</h3><div class="amount">$199<span>/mo</span></div><ul><li>Unlimited transactions</li><li>Full LC service</li><li>FX access</li><li>API</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Corporate</h3><div class="amount">$999<span>/mo</span></div><ul><li>Custom limits</li><li>Dedicated trader</li><li>Priority settlement</li><li>White-label</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
