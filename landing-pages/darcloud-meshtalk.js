// MeshTalk — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
...
<title>MeshTalk | Encrypted Mesh Communication OS | DarCloud Empire</title>
<meta name="description" content="End-to-end encrypted messaging and communication platform built on FungiMesh network. Decentralized, private, unstoppable.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F k</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#8b5cf6;font-weight:600;margin-bottom:.5rem">Encrypted Mesh Communication OS</p>
  <h1><span>MeshTalk</span></h1>
  <p>End-to-end encrypted messaging and communication platform built on FungiMesh network. Decentralized, private, unstoppable.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">E2E</div><div class="label">Encryption</div></div><div class="stat"><div class="val">P2P</div><div class="label">Architecture</div></div><div class="stat"><div class="val">0</div><div class="label">Data Stored</div></div><div class="stat"><div class="val">\u221E</div><div class="label">Privacy</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDD10</div><h3>E2E Encryption</h3><p>Military-grade encryption on all messages, calls, and file transfers. Zero-knowledge architecture</p></div><div class="card"><div class="icon">\uD83D\uDD78\uFE0F</div><h3>Mesh Routing</h3><p>Messages route through FungiMesh network — no central server, no single point of failure</p></div><div class="card"><div class="icon">\uD83D\uDCDE</div><h3>Voice & Video</h3><p>Crystal-clear encrypted voice and video calls routed through mesh nodes</p></div><div class="card"><div class="icon">\uD83D\uDCC1</div><h3>Secure Sharing</h3><p>End-to-end encrypted file sharing with no size limits through mesh network</p></div><div class="card"><div class="icon">\uD83D\uDC65</div><h3>Group Channels</h3><p>Encrypted group chats with role-based access control and audit logs</p></div><div class="card"><div class="icon">\uD83C\uDF0D</div><h3>Global Mesh</h3><p>Available on 6 continents through FungiMesh node network with auto-healing</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Free</h3><div class="amount">Free</div><ul><li>Text messaging</li><li>Voice calls</li><li>Basic groups</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Pro</h3><div class="amount">$9.99<span>/mo</span></div><ul><li>Video calls</li><li>Unlimited groups</li><li>File sharing 100GB</li><li>Priority routing</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Business</h3><div class="amount">$29.99<span>/mo</span></div><ul><li>Admin console</li><li>Compliance tools</li><li>API access</li><li>Custom domains</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
