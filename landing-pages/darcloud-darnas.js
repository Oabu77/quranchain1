// DarAlNas — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarAlNas", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarAlNas | Islamic Community & Social Platform | DarCloud Empire</title>
<meta name="description" content="The halal social network connecting the global Muslim ummah. Community building, knowledge sharing, and charitable giving.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F s</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#f59e0b;font-weight:600;margin-bottom:.5rem">Islamic Community & Social Platform</p>
  <h1><span>DarAlNas</span></h1>
  <p>The halal social network connecting the global Muslim ummah. Community building, knowledge sharing, and charitable giving.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">1.8B</div><div class="label">Muslims Worldwide</div></div><div class="stat"><div class="val">100%</div><div class="label">Halal Content</div></div><div class="stat"><div class="val">2%</div><div class="label">Zakat Fund</div></div><div class="stat"><div class="val">24/7</div><div class="label">Moderation</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDD4C</div><h3>Community Hub</h3><p>Connect with fellow Muslims worldwide. Prayer groups, study circles, and community events</p></div><div class="card"><div class="icon">\uD83D\uDCD6</div><h3>Islamic Learning</h3><p>Quran study, hadith collections, and Islamic scholarship curated by verified scholars</p></div><div class="card"><div class="icon">\uD83E\uDD32</div><h3>Sadaqah & Zakat</h3><p>Transparent charitable giving with blockchain-verified fund distribution</p></div><div class="card"><div class="icon">\uD83C\uDF1F</div><h3>Halal Marketplace</h3><p>Buy and sell halal products and services verified by community standards</p></div><div class="card"><div class="icon">\uD83D\uDCF1</div><h3>Prayer Times</h3><p>Accurate prayer times, Qibla direction, and mosque finder for your location</p></div><div class="card"><div class="icon">\uD83C\uDF10</div><h3>Multi-Language</h3><p>Available in Arabic, English, Urdu, Turkish, Malay, and 20+ languages</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Community</h3><div class="amount">Free</div><ul><li>Social feed</li><li>Prayer times</li><li>Mosque finder</li><li>Basic groups</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Premium</h3><div class="amount">$4.99<span>/mo</span></div><ul><li>Ad-free</li><li>Priority support</li><li>Advanced learning</li><li>Exclusive content</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Organization</h3><div class="amount">$49<span>/mo</span></div><ul><li>Mosque/org page</li><li>Event management</li><li>Fundraising tools</li><li>Analytics</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
