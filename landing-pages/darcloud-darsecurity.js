// DarSecurity — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarSecurity", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarSecurity | Islamic Cybersecurity & Data Protection | DarCloud Empire</title>
<meta name="description" content="Enterprise-grade cybersecurity infrastructure with Islamic ethical standards. Protect your data, protect your ummah.">
<style>
...
<section class="hero">
  <p style="color:#ef4444;font-weight:600;margin-bottom:.5rem">Islamic Cybersecurity & Data Protection</p>
  <h1><span>DarSecurity</span></h1>
  <p>Enterprise-grade cybersecurity infrastructure with Islamic ethical standards. Protect your data, protect your ummah.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">24/7</div><div class="label">SOC</div></div><div class="stat"><div class="val">AI</div><div class="label">Threat Detection</div></div><div class="stat"><div class="val">Zero</div><div class="label">Trust</div></div><div class="stat"><div class="val">Quantum</div><div class="label">Ready</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDEE1\uFE0F</div><h3>SOC-as-a-Service</h3><p>24/7 Security Operations Center with AI-powered threat detection and response</p></div><div class="card"><div class="icon">\uD83D\uDD10</div><h3>Zero Trust</h3><p>Complete zero-trust architecture implementation for organizations</p></div><div class="card"><div class="icon">\uD83E\uDDEC</div><h3>Quantum Security</h3><p>Post-quantum cryptography ready — future-proof your data today</p></div><div class="card"><div class="icon">\uD83D\uDC1B</div><h3>Penetration Testing</h3><p>Ethical penetration testing and vulnerability assessments by certified professionals</p></div><div class="card"><div class="icon">\uD83D\uDCCB</div><h3>Compliance</h3><p>GDPR, ISO 27001, SOC2, and Shariah compliance audit and certification</p></div><div class="card"><div class="icon">\uD83C\uDFEB</div><h3>Training</h3><p>Cybersecurity awareness training tailored for Islamic organizations</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Essential</h3><div class="amount">$99<span>/mo</span></div><ul><li>Vulnerability scan</li><li>Basic monitoring</li><li>Email alerts</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Professional</h3><div class="amount">$499<span>/mo</span></div><ul><li>24/7 SOC</li><li>Incident response</li><li>Pen testing</li><li>Compliance</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$2499<span>/mo</span></div><ul><li>Dedicated team</li><li>Quantum security</li><li>Custom SLA</li><li>Red team</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
