// DarMedia — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarMedia", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarMedia | Islamic Media & Content Platform | DarCloud Empire</title>
<meta name="description" content="Halal streaming, publishing, and content creation tools for Islamic media professionals and organizations.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F a</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#d946ef;font-weight:600;margin-bottom:.5rem">Islamic Media & Content Platform</p>
  <h1><span>DarMedia</span></h1>
  <p>Halal streaming, publishing, and content creation tools for Islamic media professionals and organizations.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">100%</div><div class="label">Halal Content</div></div><div class="stat"><div class="val">4K</div><div class="label">Streaming</div></div><div class="stat"><div class="val">AI</div><div class="label">Production</div></div><div class="stat"><div class="val">Global</div><div class="label">Distribution</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83C\uDFA5</div><h3>Halal Streaming</h3><p>Ad-free Islamic content streaming — lectures, documentaries, nasheeds, and family entertainment</p></div><div class="card"><div class="icon">\uD83C\uDFA4</div><h3>Podcast Hub</h3><p>Islamic podcast hosting and distribution with monetization tools</p></div><div class="card"><div class="icon">\uD83D\uDCF0</div><h3>News Platform</h3><p>Curated Islamic news from verified sources with fact-checking AI</p></div><div class="card"><div class="icon">\uD83C\uDFA8</div><h3>Content Studio</h3><p>AI-powered content creation tools for Islamic media professionals</p></div><div class="card"><div class="icon">\uD83D\uDCF1</div><h3>Social Sharing</h3><p>Integrated with DarAlNas for community distribution and engagement</p></div><div class="card"><div class="icon">\uD83D\uDCB0</div><h3>Creator Economy</h3><p>Monetize halal content with DarPay — transparent revenue sharing</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Viewer</h3><div class="amount">Free</div><ul><li>Basic streaming</li><li>News feed</li><li>Community content</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Creator</h3><div class="amount">$14.99<span>/mo</span></div><ul><li>Unlimited streaming</li><li>Podcast hosting</li><li>Content tools</li><li>Monetization</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Studio</h3><div class="amount">$199<span>/mo</span></div><ul><li>Multi-channel</li><li>AI production</li><li>Analytics</li><li>White-label</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
