// DarHealth — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarHealth", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarHealth | Islamic Healthcare & Telemedicine | DarCloud Empire</title>
<meta name="description" content="Halal healthcare services, telemedicine, and health records on blockchain. Accessible Islamic medicine for the ummah.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F h</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#22c55e;font-weight:600;margin-bottom:.5rem">Islamic Healthcare & Telemedicine</p>
  <h1><span>DarHealth</span></h1>
  <p>Halal healthcare services, telemedicine, and health records on blockchain. Accessible Islamic medicine for the ummah.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">100%</div><div class="label">Halal Medicine</div></div><div class="stat"><div class="val">E2E</div><div class="label">Encrypted Records</div></div><div class="stat"><div class="val">24/7</div><div class="label">Telemedicine</div></div><div class="stat"><div class="val">AI</div><div class="label">Diagnostics</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83C\uDFE5</div><h3>Telemedicine</h3><p>24/7 access to Muslim doctors and specialists via encrypted video consultations</p></div><div class="card"><div class="icon">\uD83D\uDC8A</div><h3>Halal Pharmacy</h3><p>Verified halal medications and supplements with blockchain-traced ingredients</p></div><div class="card"><div class="icon">\uD83D\uDCCB</div><h3>Health Records</h3><p>Blockchain-secured medical records with patient-controlled access</p></div><div class="card"><div class="icon">\uD83E\uDD16</div><h3>AI Diagnostics</h3><p>AI-assisted health screening and preventive care recommendations</p></div><div class="card"><div class="icon">\uD83E\uDDEC</div><h3>Genetic Privacy</h3><p>Genetic testing with zero-knowledge proofs — your DNA, your data</p></div><div class="card"><div class="icon">\uD83E\uDD32</div><h3>Charity Care</h3><p>Zakat-funded healthcare access for underserved communities worldwide</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Basic</h3><div class="amount">Free</div><ul><li>Health records</li><li>Community support</li><li>Prayer wellness</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Premium</h3><div class="amount">$29<span>/mo</span></div><ul><li>Telemedicine</li><li>AI screening</li><li>Halal pharmacy</li><li>Priority booking</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Family</h3><div class="amount">$79<span>/mo</span></div><ul><li>Up to 6 members</li><li>Specialist access</li><li>Genetic screening</li><li>Dental/Vision</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
