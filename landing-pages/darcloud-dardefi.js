// DarDeFi — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarDeFi", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarDeFi | Islamic Decentralized Finance | DarCloud Empire</title>
<meta name="description" content="Shariah-compliant DeFi protocols. Yield farming without riba, liquidity pools with ethical standards, and transparent governance.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F i</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#14b8a6;font-weight:600;margin-bottom:.5rem">Islamic Decentralized Finance</p>
  <h1><span>DarDeFi</span></h1>
  <p>Shariah-compliant DeFi protocols. Yield farming without riba, liquidity pools with ethical standards, and transparent governance.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">0%</div><div class="label">Interest</div></div><div class="stat"><div class="val">47</div><div class="label">Chains</div></div><div class="stat"><div class="val">Mudarabah</div><div class="label">Yield</div></div><div class="stat"><div class="val">DAO</div><div class="label">Governance</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83C\uDFE6</div><h3>Halal Yield</h3><p>Mudarabah-based yield generation — profit sharing, not interest charging</p></div><div class="card"><div class="icon">\uD83D\uDCA7</div><h3>Liquidity Pools</h3><p>Shariah-certified liquidity pools with transparent fee distribution</p></div><div class="card"><div class="icon">\uD83D\uDD04</div><h3>Token Swap</h3><p>Decentralized token exchange across 47 chains with best-rate routing</p></div><div class="card"><div class="icon">\uD83C\uDFDB\uFE0F</div><h3>DAR Governance</h3><p>Decentralized governance with Shura-inspired community voting</p></div><div class="card"><div class="icon">\uD83D\uDCB0</div><h3>Staking</h3><p>Stake QRN tokens for network validation rewards — no riba, pure profit sharing</p></div><div class="card"><div class="icon">\uD83D\uDD12</div><h3>Audit</h3><p>All smart contracts audited for both security and Shariah compliance</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Holder</h3><div class="amount">Free</div><ul><li>Token swap</li><li>Basic staking</li><li>Portfolio view</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Trader</h3><div class="amount">$29<span>/mo</span></div><ul><li>Advanced swaps</li><li>Yield farming</li><li>Analytics</li><li>API</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Institutional</h3><div class="amount">$999<span>/mo</span></div><ul><li>OTC desk</li><li>Custom pools</li><li>Compliance reports</li><li>SLA</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
