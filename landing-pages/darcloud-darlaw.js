// DarLaw — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarLaw", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarLaw | Islamic Legal & Compliance Platform | DarCloud Empire</title>
<meta name="description" content="Shariah-compliant legal services, smart contracts, and regulatory compliance for Islamic finance and business.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F w</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#ef4444;font-weight:600;margin-bottom:.5rem">Islamic Legal & Compliance Platform</p>
  <h1><span>DarLaw</span></h1>
  <p>Shariah-compliant legal services, smart contracts, and regulatory compliance for Islamic finance and business.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">500+</div><div class="label">Legal Templates</div></div><div class="stat"><div class="val">47</div><div class="label">Jurisdictions</div></div><div class="stat"><div class="val">AI</div><div class="label">Contract Review</div></div><div class="stat"><div class="val">100%</div><div class="label">Shariah Audit</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\u2696\uFE0F</div><h3>Smart Contracts</h3><p>Shariah-compliant smart contracts with automated execution and dispute resolution</p></div><div class="card"><div class="icon">\uD83D\uDCDC</div><h3>Legal Templates</h3><p>500+ legal document templates for Islamic finance, business, and family law</p></div><div class="card"><div class="icon">\uD83E\uDD16</div><h3>AI Legal Review</h3><p>AI-powered contract analysis ensuring Shariah compliance and risk assessment</p></div><div class="card"><div class="icon">\uD83C\uDFDB\uFE0F</div><h3>Regulatory</h3><p>Multi-jurisdiction regulatory compliance for Islamic banking and finance</p></div><div class="card"><div class="icon">\uD83D\uDD0D</div><h3>IP Protection</h3><p>Comprehensive intellectual property protection and patent filing services</p></div><div class="card"><div class="icon">\uD83D\uDCBC</div><h3>Corporate Filing</h3><p>Company formation, governance, and annual filing across 47 jurisdictions</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Basic</h3><div class="amount">$29<span>/mo</span></div><ul><li>5 document templates/mo</li><li>Basic AI review</li><li>Email support</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Professional</h3><div class="amount">$149<span>/mo</span></div><ul><li>Unlimited templates</li><li>Full AI review</li><li>Priority support</li><li>Smart contracts</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$999<span>/mo</span></div><ul><li>Dedicated counsel</li><li>Custom contracts</li><li>Regulatory filing</li><li>SLA</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
