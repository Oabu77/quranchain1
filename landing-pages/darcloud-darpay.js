// DarPay — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarPay", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarPay | Islamic Payment Processing & Revenue Engine | DarCloud Empire</title>
<meta name="description" content="Shariah-compliant payment infrastructure powering the entire DarCloud ecosystem. Stripe integration, crypto on-ramps, and zero-riba transactions.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F y</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#10b981;font-weight:600;margin-bottom:.5rem">Islamic Payment Processing & Revenue Engine</p>
  <h1><span>DarPay</span></h1>
  <p>Shariah-compliant payment infrastructure powering the entire DarCloud ecosystem. Stripe integration, crypto on-ramps, and zero-riba transactions.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">47</div><div class="label">Planned Chain Integrations</div></div><div class="stat"><div class="val">$0</div><div class="label">Interest Charged</div></div><div class="stat"><div class="val">2%</div><div class="label">Zakat Allocation Policy</div></div><div class="stat"><div class="val">99.9%</div><div class="label">Uptime SLA</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDCB3</div><h3>Stripe Integration</h3><p>Configurable Stripe checkout and payment accounting. Ledger allocations do not verify completed payouts.</p></div><div class="card"><div class="icon">\u26D3\uFE0F</div><h3>Gas Toll Highway</h3><p>Planned multi-chain gas toll integration with a 30% founder royalty policy. Live collection has not been verified.</p></div><div class="card"><div class="icon">\uD83D\uDD12</div><h3>Zero-Riba Guarantee</h3><p>All transactions are Shariah-certified with no interest, no hidden fees, and full transparency</p></div><div class="card"><div class="icon">\uD83E\uDD32</div><h3>Zakat Allocation</h3><p>Policy target: allocate 2% of eligible revenue to community welfare. Actual distributions require payment verification.</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>Revenue Dashboard</h3><p>Authenticated payment records with allocation policy: 30% Founder, 40% AI, 10% Hardware, 18% Ecosystem, 2% Zakat. Records require reconciliation with the processor.</p></div><div class="card"><div class="icon">\uD83C\uDF10</div><h3>Multi-Currency</h3><p>Planned fiat and crypto integrations. Supported currencies and conversion availability depend on configured providers.</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Starter</h3><div class="amount">Free</div><ul><li>Basic payments</li><li>QRN Wallet</li><li>Community support</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Professional</h3><div class="amount">$49<span>/mo</span></div><ul><li>Stripe checkout</li><li>Revenue analytics</li><li>API access</li><li>Priority support</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$499<span>/mo</span></div><ul><li>Custom integration</li><li>White-label</li><li>Dedicated manager</li><li>SLA 99.9%</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
