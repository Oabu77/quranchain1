// DarTelecom — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "DarTelecom", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>DarTelecom | Islamic Telecommunications Network | DarCloud Empire</title>
<meta name="description" content="Mesh-powered telecom infrastructure. Decentralized connectivity, encrypted communications, community ownership.">
<style>
...
<nav class="nav"><a href="/" class="nav-brand">\u2601\uFE0F m</a><div class="nav-links"><a href="https://darcloud.host">DarCloud</a><a href="https://darcloud.net">Pricing</a><a href="https://ai.darcloud.host">AI</a><a href="https://mesh.darcloud.host">Mesh</a><a href="https://api.darcloud.host/api">API</a><a href="https://discord.gg/darcloud" target="_blank" rel="noopener">Discord</a><a href="https://darcloud.host/login">Sign In</a><a href="https://darcloud.host/checkout/pro" style="background:linear-gradient(135deg,var(--emerald),var(--cyan));color:#000;padding:.4rem 1rem;border-radius:8px;font-weight:600">Get Started</a></div></nav>
<section class="hero">
  <p style="color:#06b6d4;font-weight:600;margin-bottom:.5rem">Islamic Telecommunications Network</p>
  <h1><span>DarTelecom</span></h1>
  <p>Mesh-powered telecom infrastructure. Decentralized connectivity, encrypted communications, community ownership.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">6</div><div class="label">Continents</div></div><div class="stat"><div class="val">Mesh</div><div class="label">Network</div></div><div class="stat"><div class="val">E2E</div><div class="label">Encrypted</div></div><div class="stat"><div class="val">P2P</div><div class="label">Calls</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83D\uDCF6</div><h3>Mesh Connectivity</h3><p>FungiMesh-powered internet access with self-healing network topology</p></div><div class="card"><div class="icon">\uD83D\uDCDE</div><h3>VoIP Calling</h3><p>E2E encrypted voice calls routed through decentralized mesh nodes</p></div><div class="card"><div class="icon">\uD83D\uDCE1</div><h3>IoT Gateway</h3><p>Connect and manage IoT devices through secure mesh infrastructure</p></div><div class="card"><div class="icon">\uD83C\uDF10</div><h3>CDN</h3><p>Edge content delivery through FungiMesh nodes on 6 continents</p></div><div class="card"><div class="icon">\uD83D\uDDA5\uFE0F</div><h3>Virtual PBX</h3><p>Cloud-based phone system for businesses with Islamic IVR options</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>Network Analytics</h3><p>Real-time network monitoring and traffic optimization dashboard</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Personal</h3><div class="amount">$9.99<span>/mo</span></div><ul><li>Mesh access</li><li>VoIP calls</li><li>10GB data</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card featured"><h3>Business</h3><div class="amount">$49<span>/mo</span></div><ul><li>Unlimited data</li><li>PBX system</li><li>IoT gateway</li><li>Analytics</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Carrier</h3><div class="amount">$499<span>/mo</span></div><ul><li>White-label</li><li>Custom network</li><li>SLA 99.99%</li><li>API access</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
