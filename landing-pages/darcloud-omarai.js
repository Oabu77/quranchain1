// OmarAI — DarCloud Empire Landing Page (Cloudflare Worker)
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
    if (request.method === "OPTIONS") return new Response(null, { status: 204, headers: { "Access-Control-Allow-Origin": "*" } });
    if (url.pathname === "/health") return new Response(JSON.stringify({ status: "healthy", service: "OmarAI", platform: "Cloudflare Workers" }), { headers: { "Content-Type": "application/json" } });
    return new Response(`<!DOCTYPE html>
<html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>OmarAI | Islamic Artificial Intelligence | DarCloud Empire</title>
<meta name="description" content="Ethical AI built on Islamic principles. From NLP to computer vision, advancing technology with faith-based values.">
<style>
...
<section class="hero">
  <p style="color:#6366f1;font-weight:600;margin-bottom:.5rem">Islamic Artificial Intelligence</p>
  <h1><span>OmarAI</span></h1>
  <p>Ethical AI built on Islamic principles. From NLP to computer vision, advancing technology with faith-based values.</p>
  <div class="hero-btns">
...
<div class="stats"><div class="stat"><div class="val">LLM</div><div class="label">Models</div></div><div class="stat"><div class="val">100+</div><div class="label">Languages</div></div><div class="stat"><div class="val">Ethical</div><div class="label">AI Standards</div></div><div class="stat"><div class="val">Open</div><div class="label">Source</div></div></div>
<section class="section">
  <h2>Features</h2>
  <p class="sub">Everything you need, built on Islamic principles</p>
  <div class="grid"><div class="card"><div class="icon">\uD83E\uDDE0</div><h3>Islamic LLM</h3><p>Large language model trained on Islamic scholarship with Shariah-aware reasoning</p></div><div class="card"><div class="icon">\uD83D\uDDE3\uFE0F</div><h3>Arabic NLP</h3><p>State-of-the-art Arabic natural language processing including Classical Arabic</p></div><div class="card"><div class="icon">\uD83D\uDC41\uFE0F</div><h3>Vision AI</h3><p>Halal food recognition, Arabic OCR, and Islamic art generation</p></div><div class="card"><div class="icon">\uD83E\uDD16</div><h3>AI Agents</h3><p>Autonomous AI agents for business automation with ethical guardrails</p></div><div class="card"><div class="icon">\uD83D\uDCCA</div><h3>ML Platform</h3><p>End-to-end machine learning platform on DarCloud infrastructure</p></div><div class="card"><div class="icon">\uD83D\uDD12</div><h3>AI Ethics</h3><p>Built-in Islamic ethics framework preventing harmful or haram outputs</p></div></div>
</section>
<section class="section">
  <h2>Pricing</h2>
  <p class="sub">Transparent, Shariah-compliant pricing</p>
  <div class="pricing"><div class="price-card"><h3>Developer</h3><div class="amount">Free</div><ul><li>API access (100 calls/day)</li><li>Basic models</li><li>Community support</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Get Started</a></div><div class="price-card featured"><h3>Professional</h3><div class="amount">$79<span>/mo</span></div><ul><li>Unlimited API</li><li>Advanced models</li><li>Fine-tuning</li><li>Priority</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/pro" style="display:block;margin-top:1rem">Subscribe</a></div><div class="price-card"><h3>Enterprise</h3><div class="amount">$799<span>/mo</span></div><ul><li>Custom models</li><li>On-premises</li><li>Dedicated GPU</li><li>SLA</li></ul><a class="btn btn-primary" href="https://darcloud.host/checkout/enterprise" style="display:block;margin-top:1rem">Subscribe</a></div></div>
</section>
