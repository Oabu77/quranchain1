// Register DarRealty slash commands
require('dotenv').config();
const { REST, Routes, SlashCommandBuilder } = require('discord.js');

const commands = [
    { name: 'realty-dashboard', description: 'Real estate portfolio — properties, cities, projects' },
    { name: 'realty-residential', description: 'Dar Al Nas Real Estate™ — residential properties (31 markets)' },
    { name: 'realty-commercial', description: 'DarProperty™ — commercial real estate portfolio' },
    { name: 'realty-smartcities', description: 'Smart Cities™ — planned community developments' },
    { name: 'realty-construction', description: 'DarIstisna™ — construction finance & projects' },
    { name: 'realty-property-mgmt', description: 'Property management services & rentals' },
    { name: 'realty-tokenized', description: 'DarTokenize™ — tokenized real estate assets on chain' },
    { name: 'realty-help', description: 'DarRealty bot commands' },
...
(async () => {
  console.log(`Registering 11 DarRealty commands...`);
  try {
