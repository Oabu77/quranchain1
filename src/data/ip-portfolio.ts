...
export const ALL_PATENTS: IPProtection[] = [
  ...
  // ═══ Fintech Patents ═══
  { type: "patent", title: "Auto-Approval Mortgage System with $5K Universal Halal Down Payment", desc: "Automated property purchase approval using blockchain smart contracts, DarPay™ subscription mortgages, and AI-driven risk assessment for zero-riba home loans.", jurisdiction: "USPTO (Provisional)" },
