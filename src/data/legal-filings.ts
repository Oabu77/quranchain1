...
export const ALL_LEGAL_FILINGS: LegalFiling[] = [
  ...
  { type: "articles-of-organization", title: "DarCloud Revenue Corp — Certificate of Incorporation", entity: "DarCloud Revenue & Billing Corp", jurisdiction: "Delaware", desc: "Revenue engine, gas toll distribution, billing and DarPay™ integration." },
  ...
  { type: "articles-of-incorporation", title: "DarPay Halal Payments Inc — Certificate of Incorporation", entity: "DarPay Halal Payments Inc", jurisdiction: "Delaware", desc: "DarPay™ halal payment processing, multi-currency white-label gateway (Stripe backend)." },
