...
REQUIRED_FILES=(
    ...
    "system/darcloud/bin/darcloud-omarai"
    ...
    "system/etc/init/darcloud-omarai.rc"
)
...
echo "" 5G Modem Manager — NR/SA data + band selection"
...
echo "  10. Tunnel           — NAT traversal + STUN"
echo "  11. Omar AI™         — AMĀN sovereign controller"
echo ""
echo "All 11Messaging        — SMS/MMS/RCS gateway"
echo ""
